...
#------------
# replicating Fonseca AVR overlay plots

View(DJI_whole)

lookback_date(DJI_whole, 1, "1960-01-01", 1020)

DJI_87 <- dynamic_eta(130, DJI_whole, 1, as.Date("1983-09-07"), 1000, 1)
DJI_08 <- dynamic_eta(130, DJI_whole, 1, as.Date("2004-07-15"), 1000, 1)
DJI_11 <- dynamic_eta(130, DJI_whole, 1, as.Date("2007-05-09"), 1000, 1)
DJI_T60 <- dynamic_eta(130, DJI_whole, 1, as.Date("1955-12-30"), 1000, 1)
...
AVRDJI <- ggplot(data = DJI_87, color = "green", aes(x = n, y = eta)) +
  ...
  ggtitle("AVR Overlay DJI replicating Fonseca, green=1987, blue=2008, pink=2011, test(1960)=black")
