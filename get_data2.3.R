...
getSymbols("^DJI", from = as.Date("1987-01-01"),to = "2017-01-15", src = "yahoo")
...
measure_data(DJI, 4, as.Date("2008-09-29")-1100, 1000, 1) %>% arrange(desc(date.x)) %>% head()
...
dynamic_eta(100, DJI, 4, "2007-01-03", 1000, 1)
